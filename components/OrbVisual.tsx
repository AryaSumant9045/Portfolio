...
export default function OrbVisual() {
  return (
    <div aria-hidden className="relative mx-auto aspect-square w-full max-w-[480px]">
      ...
      <div className="absolute inset-[18%] rounded-full bg-[radial-gradient(circle,var(--blob-brand),var(--blob-aqua)_45%,transparent_70%)] blur-[70px] animate-glow" />

      {/* Halo */}
      <div className="absolute inset-[6%] rounded-full border border-line-soft" />

      {/* Rings — each spins at its own rate */}
      <div className="absolute inset-0 rounded-full border border-dashed border-line-strong animate-orbit-slow">
      ...
      <div className="absolute inset-[13%] rounded-full border border-line animate-orbit-rev">
      ...
      <div className="absolute inset-[26%] rounded-full border border-line-soft animate-orbit">
      ...
      {/* Core */}
      <div className="absolute inset-[35%] overflow-hidden rounded-full border border-line-strong bg-[radial-gradient(circle_at_32%_28%,var(--orb-1),var(--orb-2)_26%,var(--orb-3)_52%,var(--orb-4)_78%)] shadow-[0_0_60px_-8px_rgba(34,211,238,0.6),inset_0_0_40px_rgba(99,102,241,0.35)]">
